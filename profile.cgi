...
sub status_mobile {
	...
	print qq|XV“ú $m{ldate}<br>|;
	print qq|Q“ü“ú $start_day($gaming_day“ú)<hr>|;
...
#	print qq|<table width="440" border="0" cellpadding="3" bgcolor="#CCCCCC"><tr><td bgcolor="#000000" align="left" valign="top">|;
	...
	print <<"EOM";
		...
		<hr size="1" width="90%">
			...
			<font color="#99CC99">ÀÏºŞF$eggs[$m{egg}][1]</font><br>
			...
			ŒM@Í@<b>$m{medal}</b>ŒÂ<br>
			¶¼ŞÉº²İ <b>$m{coin}</b>–‡<br>
			<p>XV“ú $m{ldate}<br>$start_day $gaming_day“ú</p>
			$pet_icon
		</tt></td></tr></table>
		<tt>
