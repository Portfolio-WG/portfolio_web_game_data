...
#	my $v = int(rand(300)+300); # 基本奪国力 300 ～ 599、にゃあ鯖ver
	my $v = int(rand(300)+325); # 基本奪国力 350 ～ 700、そら鯖2.0ver→基本奪国力 325 ～ 624、そら鯖2.1ver
	my $p_c_c_c = 'p_' . &union($w{country},$country);
	if($w{$p_c_c_c} eq '2'){
		$v += 75;# 交戦時奪国力 400 ～ 699、そら鯖2.1ver
	}

	if ($union){#同盟補正　byAonori
		$v -= 8;
	}
	#暗黒人数補正　by Aonori
	$v -= (6 * $cs{member}[$w{country}]) - 33;
