...
#						qq|<input type="radio" name="war_select_switch" value="1">はい <input type="radio" name="war_select_switch" value="0" checked>いいえ<br>|;
	...
	$mes .= '交流広場の背景画像を表示しない？<br>';
	$mes .= $m{is_back_picture} ? qq|<input type="radio" name="is_back_picture" value="1" checked>はい <input type="radio" name="is_back_picture" value="0">いいえ<br>|:
						qq|<input type="radio" name="is_back_picture" value="1">はい <input type="radio" name="is_back_picture" value="0" checked>いいえ<br>|;
...
#	$m{war_select_switch} = $in{war_select_switch};
	...
	$m{is_back_picture} = $in{is_back_picture};
