#================================================
# ±ÌßØ¹Ş°Ñ‰æ–Ê Created by nanamie
#================================================
...
=cut
	print qq|<div>$menu_cmd</div>| if $layout eq '2' && $menu_cmd;
...
#			print qq|<table width="500" border="0" cellspacing="2" cellpadding="3" height="60" bgcolor="#CCCCCC"><tr>|;
			print qq|<td bgcolor="#000000" align="left" valign="top"><tt>ÅVî•ñ<br>$line|;
...
sub status_html {
	...
	if ($m{tutorial_switch}) {
		$head_mes .= qq|<font color="#FF0000">Á­°ÄØ±ÙÓ°ÄŞ</font><br>|;
	}
...
#		$country_info .= qq|<br>|;
	...
	my $pet_icon = qq|<p><img src="$icondir/pet/$m{icon_pet}" style="vertical-align: middle;"> Lv.<b>$m{icon_pet_lv}</b></p>| if $m{icon_pet} && $m{pet_icon_switch};
...
sub battle_html {
	...
	my $act_d = $m{act} > 100 ? 100 : $m{act}; 
	my $exp_d = $m{exp} > 100 ? 100 : $m{exp}; 
	$main_screen .= qq|<tr><td>$e2j{exp}F</td><td><div class="bar4"><img src="$htmldir/space.gif" style="width: $exp_d%"></div></td><td> (<b>$m{exp}</b>/<b>100</b>)<br></td></tr>|;
	...
	$main_screen .= qq|<tr><td>”æ˜J“xF</td><td><div class="bar3" width="140px"><img src="$htmldir/space.gif" style="width: $act_d%"></div></td><td> (<b>$m{act}</b>/<b>100</b>)<br></td></tr>|;
...
sub war_html {
	...
	$main_screen .= qq|$m_tokkou$units[$m{unit}][1] “—¦[<b>$m_lea</b>] <br>|;
	$main_screen .= qq|<table border="0">|;
	...
	$main_screen .= qq|$y_tokkou$units[$y{unit}][1] “—¦[<b>$y_lea</b>]<br>|;
	$main_screen .= qq|<table border="0">|;
	...
	print <<"EOM";
		<table class="table1" width="500" cellpadding="3">
			<tr>
				...
				<td align="right"><b>$cs{barrier}[$m{country}]%</b></td>
	...
	if ($union) {
		...
		<table class="table1" width="500" cellpadding="3">
			<tr>
				...
				<td align="right"><b>$cs{barrier}[$union]%</b></td>
