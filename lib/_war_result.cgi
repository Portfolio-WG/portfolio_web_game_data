...
#						$v = $v > (800 + $r_vv)  ? int(rand(200+($r_vv*0.5))+600+($r_vv*0.5)) : int($v);#にゃあ鯖ver
#						$v = $v > (900 + $r_vv)  ? int(rand(200+($r_vv*0.5))+700+($r_vv*0.5)) : int($v);#そら鯖2.0ver,以下2.1ver
						$v = $v > (1000 + $r_vv)  ? int(rand(200+($r_vv*0.5))+800+($r_vv*0.5)) : int($v);
					}
				}
			}
			else {
